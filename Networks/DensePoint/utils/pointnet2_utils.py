...
class QueryAndGroup_new(nn.Module):
    r"""
    ...
    def forward(
        ...
        grouped_features = torch.nn.functional.max_pool2d(grouped_features, kernel_size=(1, self.nsample)).squeeze(-1)
        new_features = grouped_features - features
