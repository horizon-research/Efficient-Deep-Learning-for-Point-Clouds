...
sys.path.append(os.path.join(ROOT_DIR, 'models-limited'))
...
parser.add_argument('--model_path', default='log-baseline/model_best_acc.ckpt', help='model checkpoint file path [default: log-baseline/model.ckpt]')
