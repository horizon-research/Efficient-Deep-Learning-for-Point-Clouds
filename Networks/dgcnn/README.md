...
1\. To train the **Baseline version** of DGCNN: <br>
```
python train-baseline.py 
```

2\. To train the **Delayed-Aggregation version** of DGCNN: <br>
```
python train.py 
```
...
<img src="https://user-images.githubusercontent.com/19209239/83911018-8be16380-a739-11ea-9495-6bf7dfd10a00.png" alt="drawing" width="360"/>

The **Delayed-Aggregation version**: <br>
<img src="https://user-images.githubusercontent.com/19209239/83911312-0d38f600-a73a-11ea-967f-cabf5c7092f1.png" alt="drawing" width="360"/>
